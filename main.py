                    ...
                    if context_menu['active']:
                        for option in context_menu['options']:
                            if option['enabled'] and 'rect' in option and option['rect'].collidepoint(event.pos):
                                ...
                                if action_text == 'Editar':
                                ...
                                elif action_text == 'Criar Nova Tarefa':
                                    ...
                                    if context_menu['task'] in current_node.children:
                                        current_node.children.remove(context_menu['task'])
                                elif action_text == 'Abrir':
                                    current_node = context_menu['task']
                                break
                        context_menu['active'] = False
                    else: # Lógica de clique simples e duplo-clique
                        if clicked_on_task:
